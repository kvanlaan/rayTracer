...
{
public:
    virtual glm::dvec3 shadowAttenuation(const ray& r, const glm::dvec3& pos, const isect &i) const = 0;
...
public:
    ...
    virtual glm::dvec3 shadowAttenuation(const ray& r, const glm::dvec3& pos, const isect &i) const;
